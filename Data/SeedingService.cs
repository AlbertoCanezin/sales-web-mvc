...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(1, "Meria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 1500.0, d3);
            Seller s3 = new Seller(1, "Alex Gray", "alex@gmail.com", new DateTime(1988, 1, 15), 1300.0, d2);
            Seller s4 = new Seller(1, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 1900.0, d1);
            Seller s5 = new Seller(1, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 1700.0, d4);
            Seller s6 = new Seller(1, "Alex Pink", "alexpink@gmail.com", new DateTime(1997, 3, 24), 1024.0, d3);
